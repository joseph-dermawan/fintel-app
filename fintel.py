...
def get_targeted_news():
    ...
    print("🕵️ FINTEL Agent: Scouting global markets...")
...
def send_newsletter(content):
    ...
    print("📧 FINTEL Agent: Dispatching intelligence report...")
    ...
    # (In a real production app, you might use a markdown library here, but text is safer for now)
    html_content = f"""
    <html>
      <body>
        ...
        <hr>
        <small>Generated by Gemini 2.0 Flash • Automated via GitHub Actions</small>
      </body>
    </html>
    """
...
if __name__ == "__main__":
    ...
    if not news_data:
        print("⚠️ No news found. Skipping email.")
    else:
